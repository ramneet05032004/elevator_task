...
public class elevator {
    ...
    /**
     * @param destinationFloor this is floor where person want to reach from current floor
     */
    ...
    public static void main(String args[]) {
        ...
        while(elevatorInUse) {
    		...
    		//Then the function works on user's instructions while considering the different cases
